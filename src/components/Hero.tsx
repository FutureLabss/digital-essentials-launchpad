        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="order-2 md:order-1">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-slate-900">
              Unlock the Power of <span className="text-blue-600">Digital Skills</span> in Just 6 Weeks!
            </h1>
            <p className="text-xl text-slate-700 mb-8 leading-relaxed">
              The world is going digital—are you keeping up? Whether you want to land a remote job, start a business, or work smarter, Digital Essentials gives you the skills you need to thrive.
            </p>
          ...
          <div className="order-1 md:order-2">
            <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl shadow-lg p-6 relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-blue-900 mb-4">🚀 The Ultimate Digital Skills Course for Beginners</h2>
              <p className="text-slate-700 mb-4">
                This mobile-friendly, self-paced course is designed for absolute beginners, making it easy, practical, and fun to learn digital tools that will transform your career.
              </p>
